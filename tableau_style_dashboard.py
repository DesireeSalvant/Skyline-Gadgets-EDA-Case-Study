...
# Load data from a file in the repo
@st.cache_data
def load_data():
    try:
        ...
        st.error("❌ Excel file not found. Make sure 'May Cohort Sales_data.xlsx' is in the repo.")
        return None
    except ValueError as e:
        st.error(f"❌ Sheet not found or file is invalid: {e}")
        return None
...
if df is not None:
    ...
    st.info("ℹ️ Waiting for data to load or file is missing.")
